import numpy as np
from SageFunctions_F8 import list2vertices, vertices2list, SageFunctions
...
def mutation_func(sageClass_instance: SageFunctions, offspring, ga_instance):
...
def generateInitialPopulation(SF: SageFunctions, sol_per_pop, num_genes):
...
def reduce_population(SF: SageFunctions, population: list, dimension: int):
    '''Function to eliminate repeated solution from population, should receive populationVertices as an input'''
    reduced_population = set()
